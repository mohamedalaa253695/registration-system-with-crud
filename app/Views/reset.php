...
<body>
                    ...
                    <div class="login-form-body">
                        <div class="form-gp" id="">
                          ...
                          <div class="form-gp" id="">
                            ...
                            <input type="password" id="exampleInputEmail1" name="password_confirm" >
                            <i class="ti-email"></i>
                            <div class="text-danger"></div>
                        </div>
    ...
    <script >
        let formGroup =  document.getElementsByClassName("form-gp"); 
        if (formGroup){
            
            for(let i=0 ; i < formGroup.length ;i++ ){
                 let x = document.getElementsByClassName('form-gp');
